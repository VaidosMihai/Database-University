...
<h1>
    Alegeti tabelul in care doriti sa adaugati date .
</h1>
<form class="d-flex" action="AddDataSelected.php">
    <input class="form-control me-2" type="search" name="tabel" placeholder="Nume tabel" aria-label="Search">
    <button class="btn btn-outline-info" type="submit">Selectare tabel</button>
</form>
