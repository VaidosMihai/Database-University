...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="Site_interfata/index.php" action="Site_interfata/index.php" type="submit">Baza de date a unor Universitati</a>
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="Site_interfata/index.php" action="Site_interfata/index.php" type="submit">Home</a>
                </li>
            </ul>

            <form class="d-flex" action="Site_interfata/AddData.php">

                <button type="submit" class="btn btn-outline-info">Adaugare date</button>

            </form>

            <form class="d-flex" action="Site_interfata/cautaTabel.php">
